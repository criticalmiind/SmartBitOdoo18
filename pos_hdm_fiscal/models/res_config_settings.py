...
class ResConfigSettings(models.TransientModel):
    ...
    hdm_departments = fields.One2many(related='pos_config_id.hdm_departments', readonly=True)
    hdm_department_ref = fields.Many2one(related='pos_config_id.hdm_department_ref', readonly=False)
    hdm_fc_get_ops_deps = fields.Integer(related='pos_config_id.hdm_fc_get_ops_deps', readonly=False)
